...
> From body stats to a macro-balanced meal day in one click.

---

## Overview

Users need a clearer way to act on travel planning without starting from a blank product spec.
...
```yaml
name: nutriplan-meal-planning
services:
  - name: api
    github:
      repo: Two-Weeks-Team/nutriplan-meal-planning
      branch: master
